...
const Navigation = () => {
  return (
    <div className="w-full grid grid-cols-3 items-center rounded-lg border-2 border-violet-500 p-2">
      <div></div>
      <div className="flex flex-row items-center justify-center gap-2 text-2xl md:text-3xl font-semibold">
